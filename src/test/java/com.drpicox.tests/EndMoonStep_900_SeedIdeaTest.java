...
import com.drpicox.game.idea.plants.EndMoonStep_900_SeedIdea;
import org.junit.Test;

public class EndMoonStep_900_SeedIdeaTest {

	EndMoonStep_900_SeedIdea instance;

	@Test
	public void EndMoonStep_900_SeedIdeaTestCardFactoryIdeaEndMoonStepExecutorIdeaProgressService() {
		try{
			instance = new EndMoonStep_900_SeedIdea(/*1*//*CardFactory*/new com.drpicox.game.card.CardFactory(
