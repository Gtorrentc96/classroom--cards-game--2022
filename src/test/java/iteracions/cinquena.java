...
public class cinquena {
    ...
    public static String methodsTests(Class<?> clazz, String className){
        ...
        for (Method method : clazz.getDeclaredMethods()){
            ...
            if(Modifier.isPublic(modifiers)) {
                ...
                junitCode += privateMethodCallTests(clazz, method);
            }
            junitCode += "\t\t} catch (Exception e) {}\n";
            junitCode += "\t}\n\n";
    ...
    private static String privateMethodCallTests(Class<?> clazz, Method method) {
        String junitCode = "\t\t\t";
        ...
        if(method.getReturnType().getSimpleName() != "void") {
            ...
            junitCode += "retorn = (" + method.getReturnType().getCanonicalName() + ")";
        }
